...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // When the api will be called this aToken will be in smaller case, In backend, we have taken the response coming for backend such that this token is in smaller case in authAdmin component, it in smaller case so there will be no issue.
